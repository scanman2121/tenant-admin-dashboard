...
// For this example, we'll show an empty table for inactive employees
const inactiveEmployees: any[] = []

export default function EmployeesInactive() {
    const [data] = useState(inactiveEmployees)
